<template>
    ...
    <div class="xin-widget-citys animated" :style="'height:'+height+'px'" v-if="isShow">
        <div class="xin-widget-citys-content">
            ...
            <div class="xin-widget-citys-local bdb">
                <p>当前定位城市</p>
                <p>{{localCity.cityName || "无法定位当前城市"}}</p>
            </div>
    ...
    export default {
                ...
                starCity:[
                    {
                        cityId: "110000",
                        cityName: "北京市",
                        citySpell: "BEIJINGSHI",
                        cityFirstLetter: "B"
                    },
                    {
                        cityId: "500000",
                        cityName: "重庆市",
                        citySpell: "CHONGQINGSHI",
                        cityFirstLetter: "C"
                    },
                    {
                        cityId: "310000",
                        cityName: "上海市",
                        citySpell: "SHANGHAISHI",
                        cityFirstLetter: "S"
                    },
                    {
                        cityId: "120000",
                        cityName: "天津市",
                        citySpell: "TIANJINSHI",
                        cityFirstLetter: "T"
                    }
                ],
                hotList: [],
        ...
        mounted(){
            ...
            Public.API_GET({
                url: "sysProvince",
                success: result => {
                    this._formatCityList(result.data);
                }
            });
        }
    }
